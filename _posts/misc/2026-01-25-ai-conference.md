...
経営者の意思決定を支援するために、偉人や専門家たちに多角的な視点から議論を戦わせるAIのソリューション（[FIRA - Happiness Planet](https://happiness-planet.org/service/fira/)）があり、とても興味があったので、[こちらの動画](https://youtu.be/UnHPLZNd_VI?t=455) で写っている異能たちの一部をテキスト化して、自分のGeminiでも似たようなことができるのではないかと思い、プロンプトを作っていました。
