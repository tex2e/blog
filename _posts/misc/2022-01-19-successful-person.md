...
世の中にはたくさんの「成功法則」が存在しますが、その多くは抽象的か、すでに条件を満たしていて実感できないものが多いです。
ここでは「失敗なくして成功なし」という言葉を中心に、成功するための考え方や行動指針などの基本原則について、私の考えをもとに説明します。
...
対人関係で自分のスキルや能力不足の露呈を防ぐことで失敗を回避することは、生き延びるための生存戦略の一つです。
